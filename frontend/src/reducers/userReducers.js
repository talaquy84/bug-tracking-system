...
//udpate profile
export const userUpdateProfileById = (state = {}, action) => {
  switch (action.type) {
    case USER_UPDATE_BYID_REQUEST:
      return { loading: true }
    case USER_UPDATE_BYID_SUCCESS:
      return {
        loading: false,
        success: true,
        user: action.payload
      }
    case USER_UPDATE_BYID_FAIL:
      return {
        loading: false,
        error: action.payload
      }
    case USER_UPDATE_BYID_RESET:
      return {}
    default:
      return state
  }
